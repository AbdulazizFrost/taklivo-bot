document.addEventListener('DOMContentLoaded', () => {
  ...
  const T = {
    uz: {
      ...
      venueAddr: "Toshkent sh., Chilonzor tumani, Arnasoy ko‘chasi, 10A-uy",
    ...
    ru: {
      ...
      venueTitle: "Локация",
      venueName: "«Oqsaroy» to‘yxonasi",
      venueAddr: "г. Ташкент, Чиланзарский район, ул. Арнасай, дом 10А",
    ...
    en: {
      ...
      venueAddr: "Arnasoy street 10A, Chilanzar district, Tashkent",
